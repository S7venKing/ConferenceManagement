...
public partial class ConferenceManagementDbContext : DbContext
{
    ...
    public virtual DbSet<ConferenceRegistrationPayment> ConferenceRegistrationPayments { get; set; }
    ...
    public virtual DbSet<SpeakerConference> SpeakerConference { get; set; }

    public virtual DbSet<SpeakerConferenceFile> SpeakerConferenceFile { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SpeakerConference>()
            ...
            .WithMany(s => s.SpeakerConferences)
            .HasForeignKey(sc => sc.SpeakerId);

        modelBuilder.Entity<SpeakerConference>()
            .HasOne(sc => sc.Conference)
            .WithMany(c => c.SpeakerConferences)
        ...
        modelBuilder.Entity<ConferenceRegistrationPayment>(entity =>
{
