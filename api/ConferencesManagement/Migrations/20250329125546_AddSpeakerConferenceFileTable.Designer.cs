...
namespace ConferencesManagementAPI.Migrations
{
    ...
    [Migration("20250329125546_AddSpeakerConferenceFileTable")]
    partial class AddSpeakerConferenceFileTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceRegistrationPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ConferenceRegistrationPayments");
                });
            ...
            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.Conference", b =>
                {
                    ...
                    b.Property<bool>("NeedRegistrationFee")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.SpeakerConference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SpeakerConference");
                });

            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.SpeakerConferenceFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SpeakerConferenceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SpeakerConferenceId");

                    b.ToTable("SpeakerConferenceFile");
                });
            ...
            modelBuilder.Entity("ConferenceRegistrationPayment", b =>
                {
                    b.HasOne("ConferencesManagementDAO.Data.Entities.Registration", "Registration")
                        .WithMany()
            ...
            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.SpeakerConference", b =>
                {
                    b.HasOne("ConferencesManagementDAO.Data.Entities.Conference", "Conference")
                        .WithMany("SpeakerConferences")
                        .HasForeignKey("ConferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConferencesManagementDAO.Data.Entities.Delegates", "Speaker")
                        .WithMany("SpeakerConferences")
            ...
            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.SpeakerConferenceFile", b =>
                {
                    b.HasOne("ConferencesManagementDAO.Data.Entities.SpeakerConference", "SpeakerConference")
                        .WithMany()
                        .HasForeignKey("SpeakerConferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SpeakerConference");
                });
            ...
            modelBuilder.Entity("ConferencesManagementDAO.Data.Entities.Conference", b =>
                {
                    ...
                    b.Navigation("SpeakerConferences");
                });
