    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            try
            {
                ...
                {
                    options.ListenAnyIP(7000); // Chỉ chạy HTTP
                });
                ...
                // Lấy IWebHostEnvironment
                var env = builder.Environment;

                // Đặt WebRootPath (wwwroot)
                ...
                builder.Services.AddScoped<SpeakerConferenceService>();
                builder.Services.AddScoped<SpeakerConferenceFileService>();
                ...
                builder.Services.AddScoped<SpeakerConferenceRepositories>();
                builder.Services.AddScoped<SpeakerConferenceFileRepositories>();
                builder.Services.AddScoped<SupportTicketRepositories>();
                builder.Services.AddScoped<NotificationRepositories>();
