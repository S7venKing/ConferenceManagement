...
namespace ConferencesManagementService
{
    public class RegistrationService
    {
        ...
        // Lấy đăng ký theo ID
        public async Task<ConferenceRegistrationPayment?> GetRegistrationPaymentStatusByIdAsync(int id)
        {
            try
            {
                var registration = await _registrationRepository.GetRegistrationPaymentStatus(id);
                return registration;
            }
            catch (Exception ex)
            {
        ...
        public async Task<GeneralResponseDTO> DelegateRegisterConferenceAsync(AddRegistrationRequestDTO registrationDTO)
        {
            try
            {
                ...
                var registration = new Registration
                {
                    ...
                    Status = registrationDTO.Status ?? RegistrationStatusConstants.STATUS_Pending, // Sử dụng constant
